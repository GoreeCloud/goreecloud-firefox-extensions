...
- **GoreeCloud Advanced Tab Manager 0.1.11** is a lifecycle-neutral release candidate with no accepted Stable version. Accepted unsigned SHA-256 is `9c0f44926ac1d2f213fd07f82dd18fa11bd54ceebc6cd871898fe82b962a5b02`. `.github/workflows/advanced-tab-manager-mozilla-signing.yml` rebuilds authoritative main, requires that exact digest, re-runs Glaze/security qualification, submits or securely recovers the unlisted Mozilla-signed version, verifies governed payload parity, and requires persistent signed installation plus full Firefox restart acceptance before promotion.
