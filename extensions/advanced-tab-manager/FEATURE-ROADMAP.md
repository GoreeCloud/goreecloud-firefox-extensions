...
**Lifecycle:** source-candidate 0.1.9  
...
| ATM-008 | Add rule engine, command palette, full manager, import/export, and large-session performance qualification. | Medium | In progress — rules, explicit actions, bounded command palette, manager diagnostics, and source-preserving local backup portability implemented through 0.1.9; remaining broader manager/settings, session snapshots, and qualification work planned |
