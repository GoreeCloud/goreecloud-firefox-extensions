...
**Lifecycle:** source-candidate 0.1.8  
...
| ATM-008 | Add rule engine, command palette, full manager, import/export, and large-session performance qualification. | Medium | In progress — rules, explicit actions, bounded command palette, and read-only manager diagnostics foundation implemented through 0.1.8; remaining manager/settings, import/export, and qualification work planned |
