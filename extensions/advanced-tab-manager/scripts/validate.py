...
assert "enabled: false" in rule_state, "rule automation foundation must fail closed by default"
...
assert "browser.tabs.update" not in rule_background and "browser.tabs.remove" not in rule_background, "0.1.5 rule manager must not mutate live tabs"
print("Validated Advanced Tab Manager 0.1.5 deterministic local rule-engine foundation source candidate.")
